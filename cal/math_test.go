...
func testAdd[T number](a, b T) T {
	return a + b
}

func testSub[T number](a, b T) T {
	return a - b
}

func testMul[T number](a, b T) T {
	return a * b
}

func testDiv[T number](a, b T) T {
	return a / b
}
...
var addTests = []struct {
	...
	{[]int{1, 2}, "3", []int{1, 2, 3}, nil},
	{[]int{1, 2}, []string{"3"}, []int{1, 2, 3}, nil},
	{[]string{"1", "2"}, 3, []string{"1", "2", "3"}, nil},
	{[]string{"1", "2"}, []int{3}, []string{"1", "2", "3"}, nil},
	...
	{int8(1), uint16(1<<16 - 1), testAdd(uint16(1), uint16(1<<16-1)), nil},
	{int8(1), uint32(1<<32 - 1), testAdd(uint32(1), uint32(1<<32-1)), nil},
	{int8(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{int16(1), uint16(1<<16 - 1), testAdd(int16(1), int16(-1)), nil},
	{int16(1), uint32(1<<32 - 1), testAdd(uint32(1), uint32(1<<32-1)), nil},
	{int16(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{int32(1), uint16(1<<16 - 1), testAdd(int32(1), int32(1<<16-1)), nil},
	{int32(1), uint32(1<<32 - 1), testAdd(int32(1), int32(-1)), nil},
	{int32(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{int64(1), uint16(1<<16 - 1), testAdd(int64(1), int64(1<<16-1)), nil},
	{int64(1), uint32(1<<32 - 1), testAdd(int64(1), int64(1<<32-1)), nil},
	{int64(1), uint64(1<<64 - 1), testAdd(int64(1), int64(-1)), nil},
	...
	{uint(1), uint64(1<<64 - 1), testAdd(uint(1), uint(1<<64-1)), nil},
	...
	{uint8(1), uint8(1<<8 - 1), testAdd(uint8(1), uint8(1<<8-1)), nil},
	{uint8(1), uint16(1<<16 - 1), testAdd(uint16(1), uint16(1<<16-1)), nil},
	{uint8(1), uint32(1<<32 - 1), testAdd(uint32(1), uint32(1<<32-1)), nil},
	{uint8(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{uint16(1), uint16(1<<16 - 1), testAdd(uint16(1), uint16(1<<16-1)), nil},
	{uint16(1), uint32(1<<32 - 1), testAdd(uint32(1), uint32(1<<32-1)), nil},
	{uint16(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{uint32(1), uint16(1<<16 - 1), testAdd(uint32(1), uint32(1<<16-1)), nil},
	{uint32(1), uint32(1<<32 - 1), testAdd(uint32(1), uint32(1<<32-1)), nil},
	{uint32(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{uint64(1), uint16(1<<16 - 1), testAdd(uint64(1), uint64(1<<16-1)), nil},
	{uint64(1), uint32(1<<32 - 1), testAdd(uint64(1), uint64(1<<32-1)), nil},
	{uint64(1), uint64(1<<64 - 1), testAdd(uint64(1), uint64(1<<64-1)), nil},
	...
	{float32(1), uint16(1<<16 - 1), testAdd(float32(1), float32(1<<16-1)), nil},
	{float32(1), uint32(1<<32 - 1), testAdd(float32(1), float32(1<<32-1)), nil},
	{float32(1), uint64(1<<64 - 1), testAdd(float32(1), float32(1<<64-1)), nil},
	...
	{float64(1), uint16(1<<16 - 1), testAdd(float64(1), float64(1<<16-1)), nil},
	{float64(1), uint32(1<<32 - 1), testAdd(float64(1), float64(1<<32-1)), nil},
	{float64(1), uint64(1<<64 - 1), testAdd(float64(1), float64(1<<64-1)), nil},
...
var subTests = []struct {
	...
	{[]int{1, 1, 2, 2, 3, 3}, "1", []int{2, 2, 3, 3}, nil},
	{[]int{1, 1, 2, 2, 3, 3}, 2, []int{1, 1, 3, 3}, nil},
	{[]int{1, 1, 2, 2, 3, 3}, []string{"1", "3"}, []int{2, 2}, nil},
	{[]string{"1", "1", "2", "2", "3", "3"}, 1, []string{"2", "2", "3", "3"}, nil},
	{[]string{"1", "1", "2", "2", "3", "3"}, "2", []string{"1", "1", "3", "3"}, nil},
	{[]string{"1", "1", "2", "2", "3", "3"}, []int{1, 3}, []string{"2", "2"}, nil},
	...
	{int8(1), int32(2), int32(1) - int32(2), nil},
	{int8(1), int64(2), int64(1) - int64(2), nil},
	{int8(1), uint(2), testSub(uint(1), uint(2)), nil},
	{int8(1), uint8(1<<8 - 1), int8(1) - int8(-1), nil},
	{int8(1), uint16(1<<16 - 1), testSub(uint16(1), uint16(1<<16-1)), nil},
	{int8(1), uint32(1<<32 - 1), testSub(uint32(1), uint32(1<<32-1)), nil},
	{int8(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{int8(1), float32(0.1), float32(1) - float32(0.1), nil},
	{int8(1), float64(0.1), float64(1) - float64(0.1), nil},
	...
	{int16(1), int32(2), int32(1) - int32(2), nil},
	{int16(1), int64(2), int64(1) - int64(2), nil},
	{int16(1), uint(2), testSub(uint(1), uint(2)), nil},
	{int16(1), uint8(1<<8 - 1), int16(1) - int16(1<<8-1), nil},
	{int16(1), uint16(1<<16 - 1), testSub(int16(1), int16(-1)), nil},
	{int16(1), uint32(1<<32 - 1), testSub(uint32(1), uint32(1<<32-1)), nil},
	{int16(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{int16(1), float32(0.1), float32(1) - float32(0.1), nil},
	{int16(1), float64(0.1), float64(1) - float64(0.1), nil},
	...
	{int32(1), int32(2), int32(1) - int32(2), nil},
	{int32(1), int64(2), int64(1) - int64(2), nil},
	{int32(1), uint(2), testSub(uint(1), uint(2)), nil},
	{int32(1), uint8(1<<8 - 1), int32(1) - int32(1<<8-1), nil},
	{int32(1), uint16(1<<16 - 1), testSub(int32(1), int32(1<<16-1)), nil},
	{int32(1), uint32(1<<32 - 1), testSub(int32(1), int32(-1)), nil},
	{int32(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{int32(1), float32(0.1), float32(1) - float32(0.1), nil},
	{int32(1), float64(0.1), float64(1) - float64(0.1), nil},
	...
	{int64(1), uint(2), int64(1) - int64(2), nil},
	{int64(1), uint8(1<<8 - 1), int64(1) - int64(1<<8-1), nil},
	{int64(1), uint16(1<<16 - 1), testSub(int64(1), int64(1<<16-1)), nil},
	{int64(1), uint32(1<<32 - 1), testSub(int64(1), int64(1<<32-1)), nil},
	{int64(1), uint64(1<<64 - 1), testSub(int64(1), int64(-1)), nil},
	{int64(1), float32(0.1), float32(1) - float32(0.1), nil},
	{int64(1), float64(0.1), float64(1) - float64(0.1), nil},
	{int64(1), "2", "12", errors.New("cal: Sub(-) unsupported type for 'string'")},

	{uint(1), int(2), int(1) - int(2), nil},
	{uint(1), int8(2), testSub(uint(1), uint(2)), nil},
	{uint(1), int16(2), testSub(uint(1), uint(2)), nil},
	{uint(1), int32(2), testSub(uint(1), uint(2)), nil},
	{uint(1), int64(2), int64(1) - int64(2), nil},
	{uint(1), uint(2), testSub(uint(1), uint(2)), nil},
	{uint(1), uint8(1<<8 - 1), testSub(uint(1), uint(1<<8-1)), nil},
	{uint(1), uint16(1<<16 - 1), testSub(uint(1), uint(1<<16-1)), nil},
	{uint(1), uint32(1<<32 - 1), testSub(uint(1), uint(1<<32-1)), nil},
	{uint(1), uint64(1<<64 - 1), testSub(uint(1), uint(1<<64-1)), nil},
	{uint(1), float32(0.1), float32(1) - float32(0.1), nil},
	{uint(1), float64(0.1), float64(1) - float64(0.1), nil},
	...
	{uint8(1), int32(2), int32(1) - int32(2), nil},
	{uint8(1), int64(2), int64(1) - int64(2), nil},
	{uint8(1), uint(2), testSub(uint(1), uint(2)), nil},
	{uint8(1), uint8(1<<8 - 1), testSub(uint8(1), uint8(1<<8-1)), nil},
	{uint8(1), uint16(1<<16 - 1), testSub(uint16(1), uint16(1<<16-1)), nil},
	{uint8(1), uint32(1<<32 - 1), testSub(uint32(1), uint32(1<<32-1)), nil},
	{uint8(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{uint8(1), float32(0.1), float32(1) - float32(0.1), nil},
	{uint8(1), float64(0.1), float64(1) - float64(0.1), nil},
	{uint8(1), "2", "12", errors.New("cal: Sub(-) unsupported type for 'string'")},

	{uint16(1), int(2), int(1) - int(2), nil},
	{uint16(1), int8(2), testSub(uint16(1), uint16(2)), nil},
	{uint16(1), int16(2), int16(1) - int16(2), nil},
	{uint16(1), int32(2), int32(1) - int32(2), nil},
	{uint16(1), int64(2), int64(1) - int64(2), nil},
	{uint16(1), uint(2), testSub(uint(1), uint(2)), nil},
	{uint16(1), uint8(1<<8 - 1), testSub(uint16(1), uint16(1<<8-1)), nil},
	{uint16(1), uint16(1<<16 - 1), testSub(uint16(1), uint16(1<<16-1)), nil},
	{uint16(1), uint32(1<<32 - 1), testSub(uint32(1), uint32(1<<32-1)), nil},
	{uint16(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{uint16(1), float32(0.1), float32(1) - float32(0.1), nil},
	{uint16(1), float64(0.1), float64(1) - float64(0.1), nil},
	{uint16(1), "2", "12", errors.New("cal: Sub(-) unsupported type for 'string'")},

	{uint32(1), int(2), int(1) - int(2), nil},
	{uint32(1), int8(2), testSub(uint32(1), uint32(2)), nil},
	{uint32(1), int16(2), testSub(uint32(1), uint32(2)), nil},
	{uint32(1), int32(2), int32(1) - int32(2), nil},
	{uint32(1), int64(2), int64(1) - int64(2), nil},
	{uint32(1), uint(2), testSub(uint(1), uint(2)), nil},
	{uint32(1), uint8(1<<8 - 1), testSub(uint32(1), uint32(1<<8-1)), nil},
	{uint32(1), uint16(1<<16 - 1), testSub(uint32(1), uint32(1<<16-1)), nil},
	{uint32(1), uint32(1<<32 - 1), testSub(uint32(1), uint32(1<<32-1)), nil},
	{uint32(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{uint32(1), float32(0.1), float32(1) - float32(0.1), nil},
	{uint32(1), float64(0.1), float64(1) - float64(0.1), nil},
	{uint32(1), "2", "12", errors.New("cal: Sub(-) unsupported type for 'string'")},

	{uint64(1), int(2), int(1) - int(2), nil},
	{uint64(1), int8(2), testSub(uint64(1), uint64(2)), nil},
	{uint64(1), int16(2), testSub(uint64(1), uint64(2)), nil},
	{uint64(1), int32(2), testSub(uint64(1), uint64(2)), nil},
	{uint64(1), int64(2), int64(1) - int64(2), nil},
	{uint64(1), uint(2), testSub(uint64(1), uint64(2)), nil},
	{uint64(1), uint8(1<<8 - 1), testSub(uint64(1), uint64(1<<8-1)), nil},
	{uint64(1), uint16(1<<16 - 1), testSub(uint64(1), uint64(1<<16-1)), nil},
	{uint64(1), uint32(1<<32 - 1), testSub(uint64(1), uint64(1<<32-1)), nil},
	{uint64(1), uint64(1<<64 - 1), testSub(uint64(1), uint64(1<<64-1)), nil},
	{uint64(1), float32(0.1), float32(1) - float32(0.1), nil},
	{uint64(1), float64(0.1), float64(1) - float64(0.1), nil},
	...
	{float32(1), uint(2), float32(1) - float32(2), nil},
	{float32(1), uint8(1<<8 - 1), float32(1) - float32(1<<8-1), nil},
	{float32(1), uint16(1<<16 - 1), testSub(float32(1), float32(1<<16-1)), nil},
	{float32(1), uint32(1<<32 - 1), testSub(float32(1), float32(1<<32-1)), nil},
	{float32(1), uint64(1<<64 - 1), testSub(float32(1), float32(1<<64-1)), nil},
	{float32(1), float32(0.1), float32(1) - float32(0.1), nil},
	{float32(1), float64(0.1), float64(1) - float64(0.1), nil},
	...
	{float64(1), uint(2), float64(1) - float64(2), nil},
	{float64(1), uint8(1<<8 - 1), float64(1) - float64(1<<8-1), nil},
	{float64(1), uint16(1<<16 - 1), testSub(float64(1), float64(1<<16-1)), nil},
	{float64(1), uint32(1<<32 - 1), testSub(float64(1), float64(1<<32-1)), nil},
	{float64(1), uint64(1<<64 - 1), testSub(float64(1), float64(1<<64-1)), nil},
	{float64(1), float32(0.1), float64(1) - float64(float32(0.1)), nil},
	{float64(1), float64(0.1), float64(1) - float64(0.1), nil},
...
var mulTests = []struct {
	...
	{int8(1), int32(2), int32(1) * int32(2), nil},
	{int8(1), int64(2), int64(1) * int64(2), nil},
	{int8(1), uint(2), testMul(uint(1), uint(2)), nil},
	{int8(1), uint8(1<<8 - 1), int8(1) * int8(-1), nil},
	{int8(1), uint16(1<<16 - 1), testMul(uint16(1), uint16(1<<16-1)), nil},
	{int8(1), uint32(1<<32 - 1), testMul(uint32(1), uint32(1<<32-1)), nil},
	{int8(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{int8(1), float32(0.1), float32(1) * float32(0.1), nil},
	{int8(1), float64(0.1), float64(1) * float64(0.1), nil},
	...
	{int16(1), int32(2), int32(1) * int32(2), nil},
	{int16(1), int64(2), int64(1) * int64(2), nil},
	{int16(1), uint(2), testMul(uint(1), uint(2)), nil},
	{int16(1), uint8(1<<8 - 1), int16(1) * int16(1<<8-1), nil},
	{int16(1), uint16(1<<16 - 1), testMul(int16(1), int16(-1)), nil},
	{int16(1), uint32(1<<32 - 1), testMul(uint32(1), uint32(1<<32-1)), nil},
	{int16(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{int16(1), float32(0.1), float32(1) * float32(0.1), nil},
	{int16(1), float64(0.1), float64(1) * float64(0.1), nil},
	...
	{int32(1), int32(2), int32(1) * int32(2), nil},
	{int32(1), int64(2), int64(1) * int64(2), nil},
	{int32(1), uint(2), testMul(uint(1), uint(2)), nil},
	{int32(1), uint8(1<<8 - 1), int32(1) * int32(1<<8-1), nil},
	{int32(1), uint16(1<<16 - 1), testMul(int32(1), int32(1<<16-1)), nil},
	{int32(1), uint32(1<<32 - 1), testMul(int32(1), int32(-1)), nil},
	{int32(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{int32(1), float32(0.1), float32(1) * float32(0.1), nil},
	{int32(1), float64(0.1), float64(1) * float64(0.1), nil},
	...
	{int64(1), uint(2), int64(1) * int64(2), nil},
	{int64(1), uint8(1<<8 - 1), int64(1) * int64(1<<8-1), nil},
	{int64(1), uint16(1<<16 - 1), testMul(int64(1), int64(1<<16-1)), nil},
	{int64(1), uint32(1<<32 - 1), testMul(int64(1), int64(1<<32-1)), nil},
	{int64(1), uint64(1<<64 - 1), testMul(int64(1), int64(-1)), nil},
	{int64(1), float32(0.1), float32(1) * float32(0.1), nil},
	{int64(1), float64(0.1), float64(1) * float64(0.1), nil},
	{int64(1), "2", "12", errors.New("cal: Multiply(*) unsupported type for 'string'")},

	{uint(1), int(2), int(1) * int(2), nil},
	{uint(1), int8(2), testMul(uint(1), uint(2)), nil},
	{uint(1), int16(2), testMul(uint(1), uint(2)), nil},
	{uint(1), int32(2), testMul(uint(1), uint(2)), nil},
	{uint(1), int64(2), int64(1) * int64(2), nil},
	{uint(1), uint(2), testMul(uint(1), uint(2)), nil},
	{uint(1), uint8(1<<8 - 1), testMul(uint(1), uint(1<<8-1)), nil},
	{uint(1), uint16(1<<16 - 1), testMul(uint(1), uint(1<<16-1)), nil},
	{uint(1), uint32(1<<32 - 1), testMul(uint(1), uint(1<<32-1)), nil},
	{uint(1), uint64(1<<64 - 1), testMul(uint(1), uint(1<<64-1)), nil},
	{uint(1), float32(0.1), float32(1) * float32(0.1), nil},
	{uint(1), float64(0.1), float64(1) * float64(0.1), nil},
	...
	{uint8(1), int32(2), int32(1) * int32(2), nil},
	{uint8(1), int64(2), int64(1) * int64(2), nil},
	{uint8(1), uint(2), testMul(uint(1), uint(2)), nil},
	{uint8(1), uint8(1<<8 - 1), testMul(uint8(1), uint8(1<<8-1)), nil},
	{uint8(1), uint16(1<<16 - 1), testMul(uint16(1), uint16(1<<16-1)), nil},
	{uint8(1), uint32(1<<32 - 1), testMul(uint32(1), uint32(1<<32-1)), nil},
	{uint8(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{uint8(1), float32(0.1), float32(1) * float32(0.1), nil},
	{uint8(1), float64(0.1), float64(1) * float64(0.1), nil},
	{uint8(1), "2", "12", errors.New("cal: Multiply(*) unsupported type for 'string'")},

	{uint16(1), int(2), int(1) * int(2), nil},
	{uint16(1), int8(2), testMul(uint16(1), uint16(2)), nil},
	{uint16(1), int16(2), int16(1) * int16(2), nil},
	{uint16(1), int32(2), int32(1) * int32(2), nil},
	{uint16(1), int64(2), int64(1) * int64(2), nil},
	{uint16(1), uint(2), testMul(uint(1), uint(2)), nil},
	{uint16(1), uint8(1<<8 - 1), testMul(uint16(1), uint16(1<<8-1)), nil},
	{uint16(1), uint16(1<<16 - 1), testMul(uint16(1), uint16(1<<16-1)), nil},
	{uint16(1), uint32(1<<32 - 1), testMul(uint32(1), uint32(1<<32-1)), nil},
	{uint16(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{uint16(1), float32(0.1), float32(1) * float32(0.1), nil},
	{uint16(1), float64(0.1), float64(1) * float64(0.1), nil},
	{uint16(1), "2", "12", errors.New("cal: Multiply(*) unsupported type for 'string'")},

	{uint32(1), int(2), int(1) * int(2), nil},
	{uint32(1), int8(2), testMul(uint32(1), uint32(2)), nil},
	{uint32(1), int16(2), testMul(uint32(1), uint32(2)), nil},
	{uint32(1), int32(2), int32(1) * int32(2), nil},
	{uint32(1), int64(2), int64(1) * int64(2), nil},
	{uint32(1), uint(2), testMul(uint(1), uint(2)), nil},
	{uint32(1), uint8(1<<8 - 1), testMul(uint32(1), uint32(1<<8-1)), nil},
	{uint32(1), uint16(1<<16 - 1), testMul(uint32(1), uint32(1<<16-1)), nil},
	{uint32(1), uint32(1<<32 - 1), testMul(uint32(1), uint32(1<<32-1)), nil},
	{uint32(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{uint32(1), float32(0.1), float32(1) * float32(0.1), nil},
	{uint32(1), float64(0.1), float64(1) * float64(0.1), nil},
	{uint32(1), "2", "12", errors.New("cal: Multiply(*) unsupported type for 'string'")},

	{uint64(1), int(2), int(1) * int(2), nil},
	{uint64(1), int8(2), testMul(uint64(1), uint64(2)), nil},
	{uint64(1), int16(2), testMul(uint64(1), uint64(2)), nil},
	{uint64(1), int32(2), testMul(uint64(1), uint64(2)), nil},
	{uint64(1), int64(2), int64(1) * int64(2), nil},
	{uint64(1), uint(2), testMul(uint64(1), uint64(2)), nil},
	{uint64(1), uint8(1<<8 - 1), testMul(uint64(1), uint64(1<<8-1)), nil},
	{uint64(1), uint16(1<<16 - 1), testMul(uint64(1), uint64(1<<16-1)), nil},
	{uint64(1), uint32(1<<32 - 1), testMul(uint64(1), uint64(1<<32-1)), nil},
	{uint64(1), uint64(1<<64 - 1), testMul(uint64(1), uint64(1<<64-1)), nil},
	{uint64(1), float32(0.1), float32(1) * float32(0.1), nil},
	{uint64(1), float64(0.1), float64(1) * float64(0.1), nil},
	...
	{float32(1), uint(2), float32(1) * float32(2), nil},
	{float32(1), uint8(1<<8 - 1), float32(1) * float32(1<<8-1), nil},
	{float32(1), uint16(1<<16 - 1), testMul(float32(1), float32(1<<16-1)), nil},
	{float32(1), uint32(1<<32 - 1), testMul(float32(1), float32(1<<32-1)), nil},
	{float32(1), uint64(1<<64 - 1), testMul(float32(1), float32(1<<64-1)), nil},
	{float32(1), float32(0.1), float32(1) * float32(0.1), nil},
	{float32(1), float64(0.1), float64(1) * float64(0.1), nil},
	...
	{float64(1), uint(2), float64(1) * float64(2), nil},
	{float64(1), uint8(1<<8 - 1), float64(1) * float64(1<<8-1), nil},
	{float64(1), uint16(1<<16 - 1), testMul(float64(1), float64(1<<16-1)), nil},
	{float64(1), uint32(1<<32 - 1), testMul(float64(1), float64(1<<32-1)), nil},
	{float64(1), uint64(1<<64 - 1), testMul(float64(1), float64(1<<64-1)), nil},
	{float64(1), float32(0.1), float64(1) * float64(float32(0.1)), nil},
	{float64(1), float64(0.1), float64(1) * float64(0.1), nil},
...
var divTests = []struct {
	...
	{int8(1), int32(2), int32(1) / int32(2), nil},
	{int8(1), int64(2), int64(1) / int64(2), nil},
	{int8(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{int8(1), uint8(1<<8 - 1), int8(1) / int8(-1), nil},
	{int8(1), uint16(1<<16 - 1), testDiv(uint16(1), uint16(1<<16-1)), nil},
	{int8(1), uint32(1<<32 - 1), testDiv(uint32(1), uint32(1<<32-1)), nil},
	{int8(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{int8(1), float32(0.1), float32(1) / float32(0.1), nil},
	{int8(1), float64(0.1), float64(1) / float64(0.1), nil},
	...
	{int16(1), int32(2), int32(1) / int32(2), nil},
	{int16(1), int64(2), int64(1) / int64(2), nil},
	{int16(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{int16(1), uint8(1<<8 - 1), int16(1) / int16(1<<8-1), nil},
	{int16(1), uint16(1<<16 - 1), testDiv(int16(1), int16(-1)), nil},
	{int16(1), uint32(1<<32 - 1), testDiv(uint32(1), uint32(1<<32-1)), nil},
	{int16(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{int16(1), float32(0.1), float32(1) / float32(0.1), nil},
	{int16(1), float64(0.1), float64(1) / float64(0.1), nil},
	...
	{int32(1), int32(2), int32(1) / int32(2), nil},
	{int32(1), int64(2), int64(1) / int64(2), nil},
	{int32(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{int32(1), uint8(1<<8 - 1), int32(1) / int32(1<<8-1), nil},
	{int32(1), uint16(1<<16 - 1), testDiv(int32(1), int32(1<<16-1)), nil},
	{int32(1), uint32(1<<32 - 1), testDiv(int32(1), int32(-1)), nil},
	{int32(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{int32(1), float32(0.1), float32(1) / float32(0.1), nil},
	{int32(1), float64(0.1), float64(1) / float64(0.1), nil},
	...
	{int64(1), uint(2), int64(1) / int64(2), nil},
	{int64(1), uint8(1<<8 - 1), int64(1) / int64(1<<8-1), nil},
	{int64(1), uint16(1<<16 - 1), testDiv(int64(1), int64(1<<16-1)), nil},
	{int64(1), uint32(1<<32 - 1), testDiv(int64(1), int64(1<<32-1)), nil},
	{int64(1), uint64(1<<64 - 1), testDiv(int64(1), int64(-1)), nil},
	{int64(1), float32(0.1), float32(1) / float32(0.1), nil},
	{int64(1), float64(0.1), float64(1) / float64(0.1), nil},
	{int64(1), "2", "12", errors.New("cal: Divide(/) unsupported type for 'string'")},

	{uint(1), int(2), int(1) / int(2), nil},
	{uint(1), int8(2), testDiv(uint(1), uint(2)), nil},
	{uint(1), int16(2), testDiv(uint(1), uint(2)), nil},
	{uint(1), int32(2), testDiv(uint(1), uint(2)), nil},
	{uint(1), int64(2), int64(1) / int64(2), nil},
	{uint(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{uint(1), uint8(1<<8 - 1), testDiv(uint(1), uint(1<<8-1)), nil},
	{uint(1), uint16(1<<16 - 1), testDiv(uint(1), uint(1<<16-1)), nil},
	{uint(1), uint32(1<<32 - 1), testDiv(uint(1), uint(1<<32-1)), nil},
	{uint(1), uint64(1<<64 - 1), testDiv(uint(1), uint(1<<64-1)), nil},
	{uint(1), float32(0.1), float32(1) / float32(0.1), nil},
	{uint(1), float64(0.1), float64(1) / float64(0.1), nil},
	...
	{uint8(1), int32(2), int32(1) / int32(2), nil},
	{uint8(1), int64(2), int64(1) / int64(2), nil},
	{uint8(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{uint8(1), uint8(1<<8 - 1), testDiv(uint8(1), uint8(1<<8-1)), nil},
	{uint8(1), uint16(1<<16 - 1), testDiv(uint16(1), uint16(1<<16-1)), nil},
	{uint8(1), uint32(1<<32 - 1), testDiv(uint32(1), uint32(1<<32-1)), nil},
	{uint8(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{uint8(1), float32(0.1), float32(1) / float32(0.1), nil},
	{uint8(1), float64(0.1), float64(1) / float64(0.1), nil},
	{uint8(1), "2", "12", errors.New("cal: Divide(/) unsupported type for 'string'")},

	{uint16(1), int(2), int(1) / int(2), nil},
	{uint16(1), int8(2), testDiv(uint16(1), uint16(2)), nil},
	{uint16(1), int16(2), int16(1) / int16(2), nil},
	{uint16(1), int32(2), int32(1) / int32(2), nil},
	{uint16(1), int64(2), int64(1) / int64(2), nil},
	{uint16(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{uint16(1), uint8(1<<8 - 1), testDiv(uint16(1), uint16(1<<8-1)), nil},
	{uint16(1), uint16(1<<16 - 1), testDiv(uint16(1), uint16(1<<16-1)), nil},
	{uint16(1), uint32(1<<32 - 1), testDiv(uint32(1), uint32(1<<32-1)), nil},
	{uint16(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{uint16(1), float32(0.1), float32(1) / float32(0.1), nil},
	{uint16(1), float64(0.1), float64(1) / float64(0.1), nil},
	{uint16(1), "2", "12", errors.New("cal: Divide(/) unsupported type for 'string'")},

	{uint32(1), int(2), int(1) / int(2), nil},
	{uint32(1), int8(2), testDiv(uint32(1), uint32(2)), nil},
	{uint32(1), int16(2), testDiv(uint32(1), uint32(2)), nil},
	{uint32(1), int32(2), int32(1) / int32(2), nil},
	{uint32(1), int64(2), int64(1) / int64(2), nil},
	{uint32(1), uint(2), testDiv(uint(1), uint(2)), nil},
	{uint32(1), uint8(1<<8 - 1), testDiv(uint32(1), uint32(1<<8-1)), nil},
	{uint32(1), uint16(1<<16 - 1), testDiv(uint32(1), uint32(1<<16-1)), nil},
	{uint32(1), uint32(1<<32 - 1), testDiv(uint32(1), uint32(1<<32-1)), nil},
	{uint32(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{uint32(1), float32(0.1), float32(1) / float32(0.1), nil},
	{uint32(1), float64(0.1), float64(1) / float64(0.1), nil},
	{uint32(1), "2", "12", errors.New("cal: Divide(/) unsupported type for 'string'")},

	{uint64(1), int(2), int(1) / int(2), nil},
	{uint64(1), int8(2), testDiv(uint64(1), uint64(2)), nil},
	{uint64(1), int16(2), testDiv(uint64(1), uint64(2)), nil},
	{uint64(1), int32(2), testDiv(uint64(1), uint64(2)), nil},
	{uint64(1), int64(2), int64(1) / int64(2), nil},
	{uint64(1), uint(2), testDiv(uint64(1), uint64(2)), nil},
	{uint64(1), uint8(1<<8 - 1), testDiv(uint64(1), uint64(1<<8-1)), nil},
	{uint64(1), uint16(1<<16 - 1), testDiv(uint64(1), uint64(1<<16-1)), nil},
	{uint64(1), uint32(1<<32 - 1), testDiv(uint64(1), uint64(1<<32-1)), nil},
	{uint64(1), uint64(1<<64 - 1), testDiv(uint64(1), uint64(1<<64-1)), nil},
	{uint64(1), float32(0.1), float32(1) / float32(0.1), nil},
	{uint64(1), float64(0.1), float64(1) / float64(0.1), nil},
	...
	{float32(1), uint(2), float32(1) / float32(2), nil},
	{float32(1), uint8(1<<8 - 1), float32(1) / float32(1<<8-1), nil},
	{float32(1), uint16(1<<16 - 1), testDiv(float32(1), float32(1<<16-1)), nil},
	{float32(1), uint32(1<<32 - 1), testDiv(float32(1), float32(1<<32-1)), nil},
	{float32(1), uint64(1<<64 - 1), testDiv(float32(1), float32(1<<64-1)), nil},
	{float32(1), float32(0.1), float32(1) / float32(0.1), nil},
	{float32(1), float64(0.1), float64(1) / float64(0.1), nil},
	...
	{float64(1), uint(2), float64(1) / float64(2), nil},
	{float64(1), uint8(1<<8 - 1), float64(1) / float64(1<<8-1), nil},
	{float64(1), uint16(1<<16 - 1), testDiv(float64(1), float64(1<<16-1)), nil},
	{float64(1), uint32(1<<32 - 1), testDiv(float64(1), float64(1<<32-1)), nil},
	{float64(1), uint64(1<<64 - 1), testDiv(float64(1), float64(1<<64-1)), nil},
	{float64(1), float32(0.1), float64(1) / float64(float32(0.1)), nil},
	{float64(1), float64(0.1), float64(1) / float64(0.1), nil},
