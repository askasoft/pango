...
func benchmarkLinkedHashSetGet(b *testing.B, lset *LinkedHashSet, size int) {
	for i := 0; i < b.N; i++ {
		for n := 0; n < size; n++ {
			lset.Get(n)
		}
...
func benchmarkLinkedHashSetAdd(b *testing.B, lset *LinkedHashSet, size int) {
	for i := 0; i < b.N; i++ {
		for n := 0; n < size; n++ {
			lset.Add(n)
		}
...
func benchmarkLinkedHashSetDel(b *testing.B, lset *LinkedHashSet, size int) {
	for i := 0; i < b.N; i++ {
		for n := 0; n < size; n++ {
			lset.Delete(n)
		}
