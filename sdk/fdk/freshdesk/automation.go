...
type AutomationRule struct {
	...
	Operator   string                 `json:"operator,omitempty"`   // AND/OR operator to combine multiple conditions in a rule
...
type AutomationPerformer struct {
	Type    int     `json:"type,omitempty"`    // AutomationPerformerAgent/Requester/AgentOrRequester/System
...
type AutomationCondition struct {
	...
	MatchType  string                `json:"match_type,omitempty"` // To check whether all conditions have to be met or atleast one. Possible values are: “all”,”any”
...
type AutomationAction struct {
	...
	PushTo          string            `json:"push_to,omitempty"`          // Channel through which the message will be sent. Possible options are:	“Slack”	“Office365”
	...
	ResourceType    string            `json:"resource_type,omitempty"`    //  	Type of the ticket. Possible values are: “Same_ticket”, ”parent_ticket”, ”tracker_ticket”, ”custom_object”
