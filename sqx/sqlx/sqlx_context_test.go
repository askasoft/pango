...
func RunWithSchemaContext(ctx context.Context, schema Schema, t *testing.T, test func(ctx context.Context, db *DB, t *testing.T)) {
	runner := func(ctx context.Context, db *DB, t *testing.T, create, drop, _ string) {
		defer func() {
...
func loadDefaultFixtureContext(ctx context.Context, db *DB, _ *testing.T) {
...
func TestNilInsertsContext(t *testing.T) {
	...
	RunWithSchemaContext(context.Background(), schema, t, func(ctx context.Context, db *DB, t *testing.T) {
		...
		// as ref.FieldByIndexes attempts to allocate nil pointer receivers for
		// writing.  This was fixed by creating & using the ref.FieldByIndexesReadOnly
