...
func TestEllipsis(t *testing.T) {
	...
	for _, tt := range cs {
		if b := Ellipsis(tt.s, tt.n, tt.e); b != tt.w {
			t.Errorf("Ellipsis(%q, %d, %q) = %q, want %q", tt.s, tt.n, tt.e, b, tt.w)
		}
	}
}
...
func TestEllipsiz(t *testing.T) {
	...
	for _, tt := range cs {
		if b := Ellipsiz(tt.s, tt.n, tt.e); b != tt.w {
			t.Errorf("Ellipsiz(%q, %d, %q) = %q, want %q", tt.s, tt.n, tt.e, b, tt.w)
		}
	}
}
