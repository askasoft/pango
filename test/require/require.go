...
func Nil(t TestingT, a any, msgs ...string) {
	if !assert.Nil(t, a, msgs...) {
		t.FailNow()
	}
}

func NotNil(t TestingT, a any, msgs ...string) {
	if !assert.NotNil(t, a, msgs...) {
		t.FailNow()
	}
}

func Zero(t TestingT, a any, msgs ...string) {
...
func Equal(t TestingT, w, a any, msgs ...string) {
	if !assert.Equal(t, w, a, msgs...) {
		t.FailNow()
	}
}

func NotEqual(t TestingT, w, a any, msgs ...string) {
...
func PanicsWithValue(t TestingT, msg string, f func()) {
	if !assert.PanicsWithValue(t, msg, f) {
		t.FailNow()
	}
}
